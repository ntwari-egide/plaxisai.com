...
const LoginComponent = () => {
  return (
    <div className='flex flex-col justify-center items-center object-center mt-[10vh]'>
      <div className='border-[1px] border-[#E6E6E7] rounded-xl w-[80vw] md:w-[35vw] flex flex-col py-[4vh] gap-[3vh]'>
        <div className='flex flex-col object-center items-center justify-center'>
          ...
          <p className='md:w-[20vw] inter-tight  font-normal text-[1.7vh] text-center'>
            Unlock your career: Just upload your resume
          </p>
        </div>

        <div className='mt-[2vh] gap-[2vh] flex flex-col items-center'>
          <div className='flex flex-row gap-[2vw] w-[70vw] md:w-[20vw] border border-[#E6E6E7] py-[1vh] cursor-pointer hover:scale-[1.02] transition-all px-[2vw] rounded-md justify-center items-center'>
            <RiGoogleFill className='text-[2vh]' />
            <p className=' inter-tight  font-medium text-[1.7vh] md:w-[15vw]'>
        ...
        <div className='mt-[2vh] flex flex-col items-center '>
          <div className='md:w-[20vw] w-[70vw] flex-col flex gap-[2vh]'>
      ...
      <p className='mt-[3vh] inter-tight text-[#848486] md:w-[20vw] text-[1.7vh] text-center font-medium w-[80vw]'>
