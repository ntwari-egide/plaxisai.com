...
const CallToActionComponent = () => {
  ...
  return (
    <div className='call-to-action relative mt-[10vh] md:mt-[35vh] flex flex-col md:gap-[6vh] ipad-portrait:mt-[15vh] place-items-center'>
      <h1
        ref={textRef}
        className='text-[#000000] text-[4vh] md:text-[8vh] font-bold text-center w-[80vw] md:w-[54vw] m-auto whyteInktrap_font md:leading-[12vh] ipad-portrait:text-[5vh] ipad-portrait:[90vw]'
      >
