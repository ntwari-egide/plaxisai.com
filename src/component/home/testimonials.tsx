...
const TestimonialsPage = () => {
  const testimonials = [
    {
      userProfileImg:
        'https://images.pexels.com/photos/13438105/pexels-photo-13438105.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      userName: 'Sarah Johns',
      university: 'Harvard University',
      uniURL: 'https://www.harvard.edu/',
      major: 'Computer Science',
      mBody:
        'Plaxis AI saved me so much time! 🎯 I used to spend hours editing my resume for every job, but now I get matched with the perfect companies instantly. Got my first interview last week!',
    },
    {
      userProfileImg:
    ...
    },
    {
      ...
      mBody:
        'I’ve been using Plaxis AI for two months, and I’m impressed by how well it understands my resume. The suggestions are always spot-on.',
    },
    {
      userProfileImg:
        'https://images.pexels.com/photos/3362294/pexels-photo-3362294.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      userName: 'Michael Chang',
      university: 'Columbia University',
      uniURL: 'https://www.columbia.edu/',
      major: 'Mathematics',
      mBody:
        'Thanks to Plaxis AI, I landed an amazing internship in data science that I probably wouldn’t have found on my own. The matching process is seamless and accurate.',
    },
    {
      userProfileImg:
      ...
      mBody:
        'Plaxis AI helped me discover opportunities that aligned with my skills and interests. I had no idea how much time I was wasting manually searching for roles before using this tool.',
    },
    {
      userProfileImg:
        'https://images.pexels.com/photos/3741018/pexels-photo-3741018.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      userName: 'Jonathan Smith',
      university: 'Brown University',
      uniURL: 'https://www.brown.edu/',
      major: 'Political Science',
      mBody:
        'Honestly, I was skeptical at first, but this AI matching tool blew my mind. It’s super intuitive, and I’ve been able to apply for internships that match my interests perfectly.      Honestly, I was skeptical at first, but this AI matching tool blew my mind. It’s super intuitive, and I’ve been able to apply for internships that match my interests perfectly.',
    },
    {
      userProfileImg:
      ...
      major: 'Architecture',
      mBody:
        'With Plaxis AI, I can focus more on preparing for interviews rather than spending countless hours editing and tailoring my resume. It’s a lifesaver for busy students!',
    },
    {
      userProfileImg:
        'https://images.pexels.com/photos/3775121/pexels-photo-3775121.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      userName: 'Olivia Wright',
      university: 'Dartmouth College',
      uniURL: 'https://home.dartmouth.edu/',
      major: 'Psychology',
      mBody:
        'The resume-job matching feature of Plaxis AI is so efficient. I’ve gotten multiple internship recommendations that align perfectly with my career goals.',
    },
    {
      userProfileImg:
      ...
      mBody:
        'I was struggling to find internships that fit my hybrid major until I found Plaxis AI. Now, I’m applying to roles that perfectly match my diverse skill set!',
    },
  ];
