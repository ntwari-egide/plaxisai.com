...
const QuickStats = () => {
    return (
        <div className="mt-[20vh] flex flex-col gap-[4vh] px-[2vw] md:px-[3vw]">
            <div>
            ...
            <div className="grid grid-cols-3 gap-[4vw]">
                <StatsComponent 
                    stat="2000+"
                    description="Students Matched!"
                />
                <StatsComponent 
                    stat="5M+"
                    description="Companies scanned for you!"
                />
                <StatsComponent 
                    stat="90%"
                    description="Accuracy in matching!"
                />
            </div>
        </div>
    )
