...
const QuickStats = () => {
  return (
    ...
    >
      <div>
        <p className='text-[#F28729] md:text-start text-center inter-tight md:text-[2vh] font-medium'>
          Stats
        </p>
        <h1 className='text-[#000000] text-[2.5vh] md:text-[4.5vh] font-bold whyteInktrap_font  text-center md:text-start md:w-[30vw] mt-4 leading-[5vh]'>
