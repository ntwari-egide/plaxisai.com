  ...
  return (
    <div className='mt-[15vh] md:mt-[23vh] z-30 px-[6vw] md:px-[3vw] pb-[4vh] '>
      <div className='min-h-[40vh] justify-between md:flex grid grid-cols-2 flex-col md:flex-row ipad-portrait:gap-[2vw] gap-[10vw]'>
        ...
        <div>
          <h2 className='text-[#000000] text-[2.5vh] md:text-[3.5vh] ipad-portrait:text-[2.4vh] font-bold'>
            Explore
          </h2>
          <ul className='flex flex-col gap-[1.5vh] mt-[2vh]'>
            <li className='text-[1.7vh] text-[#78787A] hover:text-[#000000] transition-all cursor-pointer ipad-portrait:text-[1.5vh]'>
              Resume Templates
            </li>
            <li className='text-[1.7vh] text-[#78787A] hover:text-[#000000] transition-all cursor-pointer ipad-portrait:text-[1.5vh]'>
              Resume Reviews
